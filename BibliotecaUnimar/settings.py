"""
Django settings for BibliotecaUnimar project.
...
SECRET_KEY = '90*@l2g1o73cew+k+j!i=aqgm(gt@^+h*i^l_!nla**+fx(%sh'
...
ROOT_URLCONF = 'BibliotecaUnimar.urls'
...
WSGI_APPLICATION = 'BibliotecaUnimar.wsgi.application'
